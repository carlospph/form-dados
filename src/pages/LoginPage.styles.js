...
export const styles = {
    body: "flex flex-col items-center justify-center min-h-screen bg-gray-100 p-3 pt-[5em]",
    containerForm: "bg-white shadow-md rounded-lg px-2 pt-8 pb-10 w-full max-w-sm",
    ...
    field: "border-2 border-gray-200 block mt-2 py-3 px-2 w-full rounded-lg md:text-[20px]"
};